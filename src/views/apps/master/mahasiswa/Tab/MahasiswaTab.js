...
const Index = ({ control, errors, setValue, setValueData }) => {
    const dispatch = useDispatch()

    const { data: dataProdi, loading: loadingProdi } = useSelector(state => state.prodi)
    const { data: dataDosen, loading: loadingDosen } = useSelector(state => state.dosen)
    const { data: dataStatusMhs, loading: loadingStatusMhs } = useSelector(state => state.statusMahasiswa)
