...
const Index = ({ watch, control, store, errors, isEdit, setValue: setValueData }) => {
    ...
    <Card>
      <TabContext value={value}>
        ...
        <TabPanel sx={{ p: 0 }} value='dosen'>
          <DosenTab watch={watch} control={control} errors={errors} setValue={setValue} setValueData={setValueData} />
        </TabPanel>
        <TabPanel sx={{ p: 0 }} value='perkuliahan'>
          <PerkuliahanTab watch={watch} store={store} control={control} errors={errors} setValueData={setValueData} />
        </TabPanel>
        <TabPanel sx={{ p: 0 }} value='mahasiswa'>
          <MahasiswaTab watch={watch} store={store} control={control} errors={errors} setValueData={setValueData} />
        </TabPanel>
      </TabContext>
    </Card>
  )
