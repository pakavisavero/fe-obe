...
function Index() {
  const fields = [
    {
      ...
      type: "link",
      hide: true,
      link: "/apps/master/assessment-prodi/edit/",
    ...
    },
    {
      ...
      type: "link",
      link: "/apps/transaction/assessment-prodi/edit/",
  ...
  return (
    <ListData
      ...
      nameLabel={"Assessment Prodi"}
      storeName={"assessmentProdi"}
      updateData={updateAssessmentProdi}
      urlData={"/apps/transaction/assessment-prodi/"}
      getData={fetchData}
      filterData={<FilterData storeName={"assessmentProdi"} />}
