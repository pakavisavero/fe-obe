...
function Index() {
  const fields = [
    {
      ...
      type: "link",
      hide: true,
      link: "/apps/master/siklus-prodi/edit/",
    ...
    },
    {
      ...
      type: "link",
      link: "/apps/transaction/siklus-prodi/edit/",
  ...
  return (
    <ListData
      ...
      nameLabel={"Siklus Prodi"}
      storeName={"siklusProdi"}
      updateData={updateSiklusProdi}
      urlData={"/apps/transaction/siklus-prodi/"}
      getData={fetchData}
      filterData={<FilterData storeName={"siklusProdi"} />}
