...
import { DrawColumn, DrawFilter, handleOnChangeRange, getColorPK } from 'src/utils/field'
...
const FilterData = ({ storeName }) => {
  ...
  const { data: dataMataKuliah, loading: loadingMataKuliah } = useSelector(state => state.mataKuliah)
  const { data: dataTahunAjaran, loading: loadingTahunAjaran } = useSelector(state => state.tahunAjaran)
  const { data: dataDocStatusPk, loading: loadingDocStatusPk } = useSelector(state => state.docstatusPk)
  ...
  const fields = [
    ...
    },
    {
      ...
      type: 'autocomplete',
      changeSearch: SearchhandleFilterAutoComplete('tahun_ajaran', fetchDataTahunAjaran),
...
function Index() {
  ...
  const fields = [
    ...
    },
    {
      ...
      type: 'link',
      link: '/apps/transaction/perkuliahan/edit/',
      value: value => value.mataKuliah.mata_kuliah ? value.mataKuliah.mata_kuliah : '-',
      valueLink: value => value.id
    },
    {
      name: 'docstatus',
    ...
    },
    {
      ...
      value: value => value.tahunAjaran.tahun_ajaran ? value.tahunAjaran.tahun_ajaran : '-',
    },
  ];
