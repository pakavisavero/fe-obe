import { addModule, updateModule, clearResponse } from 'src/store/apps/setting/module'
...
export const getServerSideProps = async ({ params, req, res }) => {
  try {
    ...
    const response = await axios.get(`module/${params.id}`, { headers: { token } })
      ...
      props: {
        ...
        data: {
          ...
          module_group_id_name: {
            module_name: response.data.data.moduleGroup ? response.data.data.moduleGroup.module_name : ''
          }
        }
      }
    }
